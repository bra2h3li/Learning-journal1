...
links are written like this [name of the link](http://www.URL.com),

and if you want to do list just write it like this :
1. list
2. list
3. list
OR using (.,-) also you can do nested and task lists, 
to creat a task list use : [x] doing my homework
                           [ ] reading abook
                           [ ] clean my room

nested list : - first nested item
               -second nested item

If you want to insert images : ![image](https//www.URL.com/image.png)
and you can mention people or items : @someone/the team leader.


What About Emoji ?
You Can add emoji by typing emoji code between (::) like this :shipit:

Paragraphs:
you can create a new paragraph by leaving a blank lines between lines of text.
